...
# Name: monitor-filesystem-inode-utilization.sh
# Description: a script to monitor filesystem inode utilization
################################################################
# name of script
baseName=$(basename $0)
#desc: print log
